...
public class MazeDTO extends GameDTO {

    public MazeDTO(long id, int height, int width, long seed, LocalDateTime creationDate, TypeGame typeGame, LocalDateTime lastPlayed, Status status, long elapsedTime, String notes, Difficulty difficulty, long userId, List<SettingDTO> settings) {
